...
// Build email
// -----------------------------------------------------------------------------
$to          = 'admin@bendcutsend.net';     // recipient
$fromAddress = 'no-reply@bendcutsend.net';  // must exist in Plesk Mail

$emailSubject = 'New Question from bendcutsend.net';
...
$headers[] = "Reply-To: {$safeEmailHeader}";
$headers[] = "X-Mailer: PHP/" . phpversion();
$headers[] = "Content-Type: text/plain; charset=\"UTF-8\"";

$mailResult = mail($to, $emailSubject, $plainBody, implode("\r\n", $headers));

// -----------------------------------------------------------------------------
// Redirect or show error
// -----------------------------------------------------------------------------
if ($mailResult) {
    header('Location: /thank-you.html'); // reuse same thank-you page as quote form
    exit;
} else {
